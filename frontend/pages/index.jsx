    ...
    return (
        <Container maxW="container.xl" centerContent>
            ...
            <HStack w={"full"} py={'28'}>
                ...
                <Button w={"full"} colorScheme={"teal"} float={"right"} onClick={()=>router.push('/archivos/verArchivos')} >Archivos</Button>
                <Button w={"full"} colorScheme={"teal"} float={"right"} onClick={()=>router.push('/asamblea/ver')} >Avisos</Button>
            </HStack>
        </Container>
    )
}
